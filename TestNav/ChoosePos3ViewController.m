...
@interface ChoosePos3ViewController ()

@end

@implementation ChoosePos3ViewController
...
//    UIImage *img = [UIImage imageWithContentsOfFile:filePath];
    ...
    _btn1 = [[UIButton alloc] initWithFrame:CGRectMake(4, 4, (double)304 /3, (double)(rect_screen.size.height -80) /3)];
...
- (IBAction)pressBtn:(UIButton *)sender
{
    ...
    [defaults setInteger:sender.tag forKey:@"password3"];
    ...
    if (passwordLevel == 3) {
        ...
        ChoosePos4ViewController *myPos = [[ChoosePos4ViewController alloc]init];
    ...
    //
    //    for(UIButton * aView in self.view.subviews){
    //        if([aView isKindOfClass:[UIButton class]] && aView.tag != 10){
